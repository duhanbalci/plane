...
class TestOAuthApiAccess:
    def test_read_scope_can_list_projects(self, api_client, public_application, create_user, workspace):
    ...
    def test_read_scope_cannot_write(self, api_client, public_application, create_user, workspace):
        token = issue_token(public_application, create_user, "mcp:read")
    ...
    def test_write_scope_can_write(self, api_client, public_application, create_user, workspace):
    ...
    def test_expired_token_is_rejected(self, api_client, public_application, create_user, workspace):
        token = issue_token(public_application, create_user, "mcp:read")
    ...
    def test_token_for_a_workspace_the_user_is_not_in_sees_nothing(
        ...
        other_owner = create_user.__class__.objects.create(email="other@plane.so", username="other@plane.so")
    ...
    def test_api_key_requests_are_unaffected_by_scope_checks(self, api_key_client, workspace, create_user):
