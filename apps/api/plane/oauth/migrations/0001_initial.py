# Generated by Django 5.2.15 on 2026-09-14 13:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_access_token', models.CharField(blank=True, db_index=True, max_length=255, null=True)),
                ('client_metadata_url', models.URLField(blank=True, max_length=2000, null=True)),
                ('client_metadata_fetched_at', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('resource', models.URLField(blank=True, max_length=2000, null=True)),
