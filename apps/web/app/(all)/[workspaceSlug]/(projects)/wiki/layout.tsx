...
export default function WorkspaceWikiLayout({ params }: Route.ComponentProps) {
  ...
  // the left pane needs both the collections and the whole page tree
  useSWR(workspaceSlug ? `WORKSPACE_WIKI_COLLECTIONS_${workspaceSlug}` : null, () =>
    fetchCollections(workspaceSlug)
  );
  ...
  return (
    <>
      ...
      <ContentWrapper className="flex overflow-hidden">
        <WikiSidebar workspaceSlug={workspaceSlug} />
