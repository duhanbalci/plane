  ...
  const pageRootHandlers: TPageRootHandlers = useMemo(
    () => ({
      ...
      fetchAllVersions: async (versionPageId) =>
        await workspacePageVersionService.fetchAllVersions(workspaceSlug, versionPageId),
      ...
      fetchVersionDetails: async (versionPageId, versionId) =>
        await workspacePageVersionService.fetchVersionById(workspaceSlug, versionPageId, versionId),
      restoreVersion: async (versionPageId, versionId) =>
        await workspacePageVersionService.restoreVersion(workspaceSlug, versionPageId, versionId),
